...
std::map<int, std::string> ErrorHandler::initReasonMap()
{
...
std::string ErrorHandler::getDefaultReason(int code)
{
...
std::string ErrorHandler::getErrorBodyFromFile(
...
std::string ErrorHandler::generateErrorResponse(
	int code,
	const ServerConfig_t &serverConf,
	const LocationConfig_t *locationConf,
