...
/*   Updated: 2025/09/20 15:26:15 by safandri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void ConfigParser::parseHttpBlock(std::istream &input, ServersConfig &httpConfig)
// {
//     std::string token;
//     while (input >> token)
//     {
...
//             httpConfig.push_back(server);
//         }
//         else throw std::runtime_error("Unknown directive inside http block: " + token);
//     }
// }

// ServersConfig ConfigParser::parse()
// {
//     ServersConfig httpConfig;
